  ...
  async (request) => {
    ...
    driversSnapshot.forEach((doc) => {
      ...
      drivers.push({
        ...
        approvalBypassByAdmin: driverData?.approvalBypassByAdmin || false,
        ...
        licensePhotoURL: driverData?.licensePhotoURL || null,
        insurancePhotoURL: driverData?.insurancePhotoURL || null,
        vehiclePhotoURL: driverData?.vehiclePhotoURL || null,
        registrationPhotoURL: driverData?.registrationPhotoURL || null,
